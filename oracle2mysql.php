...
if ($_POST) {    
    ...
    if (isset($_POST['table'])) {
        ...
        while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
            ...
            if ($columnName == 'ID') {
                $string .= "ID int(11) NOT NULL,"; //"ID NUMBER GENERATED ALWAYS AS IDENTITY, ";
            } else {
...
echo "<label><input type='checkbox' checked id='convertToLower'> Convertir tablas y columnas a minusculas</label><br>";
